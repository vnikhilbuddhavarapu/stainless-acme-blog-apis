...
export { ClientOptions } from 'acme-blog';
...
export function initMcpServer(params: {
  ...
  const client = new AcmeBlog(params.clientOptions);
  const capabilities = {
    ...defaultClientCapabilities,
...
export function init(params: {
  ...
  const client =
    params.client || new AcmeBlog({ defaultHeaders: { 'X-Stainless-MCP': 'true' }, logger: logger });
